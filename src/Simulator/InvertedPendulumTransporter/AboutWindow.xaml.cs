    ...
    public partial class AboutWindow : Window
    {
        ...
        private void Initialize()
        {
            ...
            windowsContents.Add(WindowType.HelpMenuAbout,
                "Application's menu is divided into three sections:\n[About] - information about program. \n\nIf you looking for some information about the application, system's mechanics or author click one of the given tabs.");
            windowsContents.Add(WindowType.HelpPlots,
                "During the animation's progress some usefull data like controll's error or engine's voltage are collected in special structures to have the possibility of presenting the results in form of plots. One plot holds X and Y coordinates values. By clicking on the given line you can see the accurate values.");
